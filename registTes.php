                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="row mb-3">
                                            <label for="notelephone" class="col-sm-4 col-form-label">No HP</label>
                                            <div class="col-sm-8">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="row mb-3">
                                            <label for="tangallahir" class="col-sm-4 col-form-label">Tanggal Lahir</label>
                                            <div class="col-sm-8">
                                        ...
                                        <div class="row mb-3">
                                            <label for="exampleInputFile" class="col-sm-4 col-form-label">Upload KTP</label>
                                            <div class="col-sm-8">
