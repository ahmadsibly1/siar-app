...
$query = mysqli_query($koneksi, "INSERT INTO pembayaran (id_pembayaran, bukti_bayar, id_user, id_kelompok, bank, tgl_bayar, jumlah, bulan) VALUES ('','$bukti_bayar','$nama_pembayar','$nama_kelompok','$bank_tujuan','$tanggal_bayar ','$jumlah','$bulan')");
...
if ($query == 1) {
    ...
    alert('$message');
    window.location.href = '../data-pembayaran.php?id_user=$nama_pembayar';
    </script>";
}
